...
const createSummaryImage = (() => {
  ...
  const generateImageName = () => path.resolve(imageDirectory, new Date().getTime() + '.png');
...
//createSummaryImage({
  //trackInfo: {
    ...
    //album: 'Icky Thump',
  //},
  //imageUrl: 'https://i.scdn.co/image/8eed82af81df8c0786194521a7e4934ee75d5a65',
...
//
//
//TODO!!!! create test for imageCreator
//TODO images aren't sending to groupme anymore after refactor
